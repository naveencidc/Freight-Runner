      ...
      <Screen style={styles.container}>
        ...
        <ScrollView style={{}}>
          <Text style={{marginTop: 15}}>
            ...
            prohibited. 8. INDEMNITY By using the Site web sites you agree to
            indemnify us and affiliated entities (collectively "Indemnities")
            ...
            use of the Site web sites, your use of the Products and Services, or
            your submission of ideas and/or related materials to us or from any
            ...
            be directed to: generator.lorem-ipsum.info 126 Electricov St. Kiev,
            Kiev 04176 Ukraine contact@lorem-ipsum.info 11. PLACE OF PERFORMANCE
            ...
            compliance with all local laws. 12. GENERAL A. If any provision of
            ...
            and communications, written or oral, between our representatives and
            you with respect to the subject matter hereof, including any terms
            and conditions on any of customer's documents or purchase orders. B.
            No Joint Venture, No Derogation of Rights. You agree that no joint
        ...
        {/* <View style={styles.buttons}>
          <PrimaryButton title="Accept" buttonStyle={styles.button} onPress={handleCancel} />
        </View> */}
      </Screen>
    </SafeAreaView>
  );
