...
function RegistrationInsuranceRequirementsScreen({ navigation, route }: Props) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          ...
          >
            Before you proceed with your application as an independent operator,
            we want you to make sure you have the required insurance coverage
            listed below
          </Text>
          <View
            style={{
          ...
          >
            ...
            <View style={{ paddingHorizontal: deviceHeight / 50 }}>
              <Text
                style={{ color: "#2F30ED", fontWeight: "bold", fontSize: 20 }}
              >
                $1,000,000
              </Text>
              <Text
...
export default RegistrationInsuranceRequirementsScreen;
