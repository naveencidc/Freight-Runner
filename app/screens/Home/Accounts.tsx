  ...
  const _renderFlatList = () => {
    return (
      <FlatList
        ...
        data={
          tabPosition === 0
            ? global.myState.allPaymentMethods.customerBank.data
            : global.myState.allPaymentMethods.customerCard.data
        }
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate("BankAccountDetails", {
              accountDetail: item,
              isFrom: tabPosition === 1 ? "cardList" : null,
              isCustomer: true,
            })
          }
        >
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              {tabPosition === 1 ? (
                <View style={{ flexDirection: "row", marginTop: 10 }}>
                  ...
                  >
                    {item.card.exp_month.toString().length === 1
            ...
            {item.id ===
            global.myState.allPaymentMethods?.customer_default_source.id ? (
                  ...
                  {global.myState.allPaymentMethods?.customerBank?.data
                    ...
                    <View style={{ marginBottom: deviceHeight / 25 }}>
                      ...
                      >
                        ...
                        >
                          Click ADD button to add new account
                        </Text>
                      </View>
                    </View>
                  )}
              ...
              {/* {global.myState.connectedAccountDetails ? (
                ...
                >
                  <CustomButton
                    ...
                    title="Stripe Connect Account not verified"
                    backgroundColor={colors.background}
                  ></CustomButton>
                </View>
              )} */}
